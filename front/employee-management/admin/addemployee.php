...
$sql="INSERT INTO tblemployees(EmpId,salary,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,City,Country,Phonenumber,Status) VALUES(:empid,:salary,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno,:status)";
...
<input id="salary" name="salary" type="tel" maxlength="10" autocomplete="off" required>
 </div>
